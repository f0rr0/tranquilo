...
<Cards>
  <Card title="Addresses" icon="map-pin" href="/docs/latest/manage/addresses">
    List saved addresses and choose the active delivery/cart address used for slot search and booking.
  </Card>
  <Card title="Payments" icon="qr-code" href="/docs/latest/manage/payments">
    Render local QR payment flows and inspect prepared checkout orders.
  </Card>
  <Card title="Bookings" icon="calendar-days" href="/docs/latest/manage/bookings">
