...
<Cards>
  <Card title="Addresses" icon="map-pin" href="/versions/v0.1.1/addresses">
    List saved addresses and choose the active delivery/cart address used for slot search and booking.
  </Card>
  <Card title="Payments" icon="qr-code" href="/versions/v0.1.1/payments">
    Render local QR payment flows and inspect prepared checkout orders.
  </Card>
  <Card title="Bookings" icon="calendar-days" href="/versions/v0.1.1/bookings">
