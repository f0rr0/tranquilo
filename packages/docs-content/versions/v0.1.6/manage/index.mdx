...
<Cards>
  <Card title="Addresses" icon="map-pin" href="/docs/versions/v0.1.6/manage/addresses">
    List saved addresses and choose the active delivery/cart address used for slot search and booking.
  </Card>
  <Card title="Payments" icon="qr-code" href="/docs/versions/v0.1.6/manage/payments">
    Render local QR payment flows and inspect prepared checkout orders.
  </Card>
  <Card title="Bookings" icon="calendar-days" href="/docs/versions/v0.1.6/manage/bookings">
